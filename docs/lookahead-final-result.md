...
This should be how your `lookaheadMath.java` class should look like now:
</p>
...
public ArrayList<Point> lineCircleIntersection(Point linePoint1 , Point linePoint2 , Point robotLocation , double lookaheadDistance){
...
public Point clipToLine(Point linePoint1 , Point linePoint2 , Point robotLocation){
        //Make sure the start point and end point of the line segment aren't the same
        /Iif they have same y values or x value s, they can have an undefined or 0 slope
...
public Point clipToPath(ArrayList<Point> path , Point robotLocation){
...
// Parameter path : Pass in the path array list that the robot is following
// Parameter robotLocation : Pass in the robot location (x position , y position)
public Point getLookaheadPoint(ArrayList<Point> path , Point robotLocation , Point currIndexInPath){
...
public ArrayList<Point> extendedPath(ArrayList<Point> path , double distance){
        ...
        endPoint.setPoint(endPoint.x + x_component , endPoint.y + y_component);
        return copyPath;
}
